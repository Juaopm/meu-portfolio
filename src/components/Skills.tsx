    ...
    },
    {
      ...
      skills: [
        ...
        },
        {
          name: "Spring Boot",
          description:
            "Framework para construção de aplicações e APIs em Java.",
        },
      ],
    },
    {
  ...
  en: [
    {
      ...
      skills: [
        ...
        {
          name: "TypeScript",
          description: "JavaScript with static and type-safe typing.",
        },
        {
          name: "JavaScript",
        ...
        },
        {
          name: "Tailwind CSS",
          description:
            "Utility-first CSS framework for styling user interfaces.",
        },
        {
          name: "HTML5 / CSS3",
      ...
      skills: [
        {
          name: "Java",
          description:
            "Object-oriented programming language for application development.",
        },
        {
          name: "Spring Boot",
          description: "Framework for building Java applications and APIs.",
        },
      ],
    },
    {
      ...
      skills: [
        ...
        {
          name: "PostgreSQL",
          description: "Robust and extensible relational database.",
        },
        {
          name: "Git / GitHub",
          description:
            "Version control and collaboration for software development.",
        },
        {
          name: "n8n",
        ...
        },
        {
          name: "Supabase",
          description:
            "Backend-as-a-service platform with database and authentication integration.",
        },
      ],
    },
  ],
...
export const Skills: React.FC = () => {
  ...
  const texts = {
    pt: {
      ...
      title: "Tecnologias",
      description:
        "Tecnologias que venho utilizando para transformar ideias em projetos e evoluir como desenvolvedor.",
    },
    en: {
      label: "// MY STACK",
      title: "Technologies",
      description:
        "Technologies I use to turn ideas into projects and grow as a developer.",
    },
  };
    ...
    >
      <div className="max-w-6xl w-full mx-auto flex flex-col items-center">
        ...
        >
          ...
          <div className="w-16 h-1 bg-linear-to-r from-purple-500 to-[#5A189A] rounded-full mt-2" />
        </motion.div>
            ...
            >
              ...
              <div className="flex items-center justify-between border-b border-purple-900/30 pb-4">
                ...
                <div className="flex gap-1.5">
                  <div className="w-2.5 h-2.5 rounded-full bg-purple-900/60" />
                  <div className="w-2.5 h-2.5 rounded-full bg-purple-600/60" />
                </div>
              </div>
                ...
                {category.skills.map((skill) => (
                  ...
                  >
                    ...
                    <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-48 p-2 bg-[#0d0b14] border border-[#5A189A]/40 text-gray-300 text-xs rounded-lg shadow-xl opacity-0 pointer-events-none group-hover/pill:opacity-100 group-hover/pill:pointer-events-auto transition-all duration-200 z-20 text-center font-light">
                      ...
                      <div className="absolute top-full left-1/2 -translate-x-1/2 border-4 border-transparent border-t-[#0d0b14]" />
                    </div>
                  </div>
                ))}
              </div>
